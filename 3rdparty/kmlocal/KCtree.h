...
public:
	...
	KMpoint		bb_lo = nullptr,		// bounding box low point
	KMpoint		bb_hi = nullptr);		// bounding box high point
...
public:
	...
	KCptr lc=nullptr, KCptr hc=nullptr)		// children
	: KCnode(dim, bb)			// create kc-node
	{
	...
	{
	    if (child[KM_LO] != nullptr) delete child[KM_LO];
	    if (child[KM_HI] != nullptr) delete child[KM_HI];
	}
